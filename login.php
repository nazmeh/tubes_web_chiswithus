...
<html lang="en">
    ...
    <div class="form-group">
        ...
        <input type="username" class="form-control border-radius-none h-40 btn-border-2px fs-14px" id="exampleInputEmail1" name="username" aria-describedby="emailHelp" placeholder="Username" />
    </div>
    <div class="form-group">
    ...
    <button type="submit" class="btn btn-primary btn-block border-radius-none border-none h-48 mt-5" name="login" style="background-color: #c37b52">
        Login
                        ...
                        <button
                            type="submit"
                            class="btn btn-primary btn-block border-radius-none h-48 btn-border-2px mt-4 loginGoogle"
                            style="color: #232323">
                            <span class="pr-2"
                                ><img src="assets/img/icongoole.svg" alt=""
                            /></span>
                            Sign in With Google
                        </button>
