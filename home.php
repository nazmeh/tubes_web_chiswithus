	      	...
	      	<div class="modal-body">
                  <form id="review_form" method="POST" action="submit_rating.php">
                    ...
                    <div class="form-group text-center mt-4">
                        <button type="submit" id="save_review" name="submit" class="btn btn-warning w-30 rounded-5 mb-5 mt-3 border-0" style="background-color: #c37b52;border: none;color: white;font-size: 12px;">
                    Submit
                </button>
                    </div>
                </form>
